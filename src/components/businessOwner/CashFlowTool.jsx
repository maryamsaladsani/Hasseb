...
function processCashFlowData(cashFlowData, dangerZone) {
    ...
    const avgCashOut =
        processedData.reduce((sum, d) => sum + d.cashOut, 0) / processedData.length;
...
function buildCashFlowSummary(result, dangerZone) {
    ...
    const { currentBalance, lowestBalance, dangerMonthsCount, firstDangerMonth, avgMonthlyBurn } =
        result.summary;
            ...
            <div className="cashflow-top-section">
                ...
                <div className="danger-zone-section tooltip-wrapper">
                    ...
                    <span className="tooltip-text">
                        Haseeb lets you set your minimum comfortable cash balance. He'll warn you
                        when your balance falls below this threshold so you can take action early.
                    </span>
                    <input
                        type="range"
                        min="0"
                    ...
                    <div className="warning-banner-cashflow tooltip-wrapper">
                        ...
                        <div>
                            ...
                            <p className="warning-text-cashflow">
                                ...
                                months: <strong>{result.summary.dangerMonthsCount}</strong>
                            </p>
                        </div>
                        <span className="tooltip-text">
                            Haseeb alerts you when your cash will drop below the danger zone you
                            set. This gives you time to arrange financing or cut costs.
                        </span>
                    </div>
                ) : (
                    <div></div>
            ...
            {result?.summary && (
                <div className="summary-cards">
                    ...
                    <div className="summary-card tooltip-wrapper">
                        ...
                        <span className="tooltip-text">
                            Haseeb warns you about the lowest point your cash will reach in the
                            coming months. If this number is negative or below your comfort zone,
                    ...
                    <div className="summary-card tooltip-wrapper">
                        ...
                        <span className="tooltip-text">
                            Haseeb identifies how many months your balance will fall below your
                            danger zone. Zero means you're safe throughout the period.
                        </span>
                    </div>
                </div>
            )}
